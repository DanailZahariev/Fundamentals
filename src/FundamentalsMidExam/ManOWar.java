        ...
        while (!command.equals("Retire")) {
            ...
            switch (commandName) {
                ...
                case "Repair":
                    ...
                    int sectionRepair = pirateShip.get(repairIndex);
                    sectionRepair += repairHealth;
                    if (sectionRepair > maxHealth) {
                        sectionRepair = maxHealth;
                    }
                    pirateShip.set(repairIndex, sectionRepair);
                    break;
                case "Status":
                    int count = 0;
